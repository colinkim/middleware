...
import (
	...
	vestingtypes "github.com/reapchain/cosmos-sdk/x/auth/vesting/types"
	...
	mintkeeper "github.com/reapchain/cosmos-sdk/x/mint/keeper"
	...
	"github.com/reapchain/ibc-go/v3/modules/apps/transfer"
	...
	ibc "github.com/reapchain/ibc-go/v3/modules/core"
	...
	ibcporttypes "github.com/reapchain/ibc-go/v3/modules/core/05-port/types"
	...
	middlewaremodule "middleware/x/middleware"
	middlewaremodulekeeper "middleware/x/middleware/keeper"
	middlewaremoduletypes "middleware/x/middleware/types"
	// this line is used by starport scaffolding # stargate/app/moduleImport
	witnessmodule "middleware/x/witness"
	witnessmodulekeeper "middleware/x/witness/keeper"
	witnessmoduletypes "middleware/x/witness/types"
...
var (
	...
	ModuleBasics = module.NewBasicManager(
		...
		middlewaremodule.AppModuleBasic{},
...
var (
	_ servertypes.Application = (*MiddleWareApp)(nil)
	_ simapp.App              = (*MiddleWareApp)(nil)
)
...
// MiddleWareApp extends an ABCI application, but with most of its parameters exported.
...
type MiddleWareApp struct {
	*baseapp.BaseApp
	...
	MiddlewareKeeper middlewaremodulekeeper.Keeper
...
// NewMiddleWareApp returns a reference to an initialized blockchain app
func NewMiddleWareApp(
	logger log.Logger,
	db dbm.DB,
	...
	keys := sdk.NewKVStoreKeys(
		...
		middlewaremoduletypes.StoreKey,
	...
	app.MiddlewareKeeper = *middlewaremodulekeeper.NewKeeper(
		appCodec,
		keys[middlewaremoduletypes.StoreKey],
		keys[middlewaremoduletypes.MemStoreKey],
		app.GetSubspace(middlewaremoduletypes.ModuleName),
	)
	middlewareModule := middlewaremodule.NewAppModule(appCodec, app.MiddlewareKeeper, app.AccountKeeper, app.BankKeeper)
	...
	app.mm.SetOrderBeginBlockers(
		...
		middlewaremoduletypes.ModuleName,
...
// Name returns the name of the MiddleWareApp
func (app *MiddleWareApp) Name() string { return app.BaseApp.Name() }

// GetBaseApp returns the base app of the application
func (app MiddleWareApp) GetBaseApp() *baseapp.BaseApp { return app.BaseApp }

// BeginBlocker application updates every begin block
func (app *MiddleWareApp) BeginBlocker(ctx sdk.Context, req abci.RequestBeginBlock) abci.ResponseBeginBlock {
	return app.mm.BeginBlock(ctx, req)
}

// EndBlocker application updates every end block
func (app *MiddleWareApp) EndBlocker(ctx sdk.Context, req abci.RequestEndBlock) abci.ResponseEndBlock {
	return app.mm.EndBlock(ctx, req)
}

// InitChainer application update at chain initialization
func (app *MiddleWareApp) InitChainer(ctx sdk.Context, req abci.RequestInitChain) abci.ResponseInitChain {
...
func (app *MiddleWareApp) LoadHeight(height int64) error {
	return app.LoadVersion(height)
}

// ModuleAccountAddrs returns all the app's module account addresses.
func (app *MiddleWareApp) ModuleAccountAddrs() map[string]bool {
...
func (app *MiddleWareApp) LegacyAmino() *codec.LegacyAmino {
	return app.cdc
}
...
// NOTE: This is solely to be used for testing purposes as it may be desirable
// for modules to register their own custom testing types.
func (app *MiddleWareApp) AppCodec() codec.Codec {
	return app.appCodec
}

// InterfaceRegistry returns an InterfaceRegistry
func (app *MiddleWareApp) InterfaceRegistry() types.InterfaceRegistry {
...
func (app *MiddleWareApp) GetKey(storeKey string) *sdk.KVStoreKey {
...
//
// NOTE: This is solely to be used for testing purposes.
func (app *MiddleWareApp) GetTKey(storeKey string) *sdk.TransientStoreKey {
...
func (app *MiddleWareApp) GetMemKey(storeKey string) *sdk.MemoryStoreKey {
...
//
// NOTE: This is solely to be used for testing purposes.
func (app *MiddleWareApp) GetSubspace(moduleName string) paramstypes.Subspace {
...
// API server.
func (app *MiddleWareApp) RegisterAPIRoutes(apiSvr *api.Server, apiConfig config.APIConfig) {
...
func (app *MiddleWareApp) RegisterTxService(clientCtx client.Context) {
	authtx.RegisterTxService(app.BaseApp.GRPCQueryRouter(), clientCtx, app.BaseApp.Simulate, app.interfaceRegistry)
}

// RegisterTendermintService implements the Application.RegisterTendermintService method.
func (app *MiddleWareApp) RegisterTendermintService(clientCtx client.Context) {
...
func initParamsKeeper(appCodec codec.BinaryCodec, legacyAmino *codec.LegacyAmino, key, tkey sdk.StoreKey) paramskeeper.Keeper {
	...
	paramsKeeper.Subspace(middlewaremoduletypes.ModuleName)
...
func (app *MiddleWareApp) SimulationManager() *module.SimulationManager {
	return app.sm
}
