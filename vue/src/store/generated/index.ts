...
import MiddlewareMiddlewareMiddleware from './middleware/middleware.middleware'
...
export default { 
  ...
  MiddlewareMiddlewareMiddleware: load(MiddlewareMiddlewareMiddleware, 'middleware.middleware'),
